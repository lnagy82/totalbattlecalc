package hu.totalbattlecalc.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hu.totalbattlecalc.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hu.totalbattlecalc.repository.UserRepository.USERS_BY_EMAIL_CACHE);
