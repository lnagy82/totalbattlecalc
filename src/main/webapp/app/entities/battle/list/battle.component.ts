...
export class BattleComponent implements OnInit {
  ...
  trackId(index: number, item: IBattle): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBattle[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
